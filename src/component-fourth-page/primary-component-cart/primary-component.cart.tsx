  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.content}>
        <div className={classes.contentImages}>
          <div>
            <div className={classes.image}>
              ...
              <h4 className={classes.price}>79.99 €</h4>
              <svg
          ...
          <div className={classes.image}>
            <img src="/assets/image-cart1.png" alt="image" />
            <div>
              <h3>Vestido</h3>
              <h3>
                Color: <span>Flores</span>
              </h3>
              <h3>
                Talla: <span>XS</span>
              </h3>
        ...
        {/* <div className={classes.contentForm}></div> */}
      </div>
    </div>
  );
};
