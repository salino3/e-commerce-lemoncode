    ...
    <div className={classes.container}>
      ...
      <div className={classes.content}>
        <div className={classes.item}>
          ...
          <img src="/assets/exito-ventas-1.png" alt="image" />
          Camiseta <br />
        ...
        <div className={classes.item}>
          ...
          <img src="/assets/exito-ventas-2.png" alt="image" />
          Vestido <br />
          <span className={classes.span}>34.95 €</span>
        </div>{" "}
        <div className={classes.item}>
          ...
          <img src="/assets/exito-ventas-3.png" alt="image" />
          Vaqueros <br />
        ...
        <div className={classes.item}>
          ...
          <img src="/assets/exito-ventas-4.png" alt="image" />
          Vestido <br />
          <span>
